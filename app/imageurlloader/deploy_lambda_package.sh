...
--function-name $(aws cloudformation describe-stacks --stack-name movie-data-app-infra --query "Stacks[0].Outputs[?OutputKey=='ImageUrlLoaderFunction'].OutputValue" --output text) \
